...
namespace appium
{
    public class NewAndroidDriver : AndroidDriver<AndroidElement>
    {
        public NewAndroidDriver(Uri remoteAddress, DesiredCapabilities desiredCapabilities) : base(remoteAddress, desiredCapabilities)
        {
